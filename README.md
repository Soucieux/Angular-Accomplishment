...
| **Entertainment** | Media tracker for **movies and TV dramas** with rich metadata support.<br>- **Douban API** lookup for title, genre, cast, and cover image<br>- Firebase / Cloudbase image storage and CDN delivery<br>- **Text search** across titles, plus category filtering, favourites toggle, and **colour-coded rating indicators**<br>- Full add / deletion history with timestamps | Stable |
