...
export const DEBT_DIALOG_LABEL_NEW_CYCLE = 'New cycle';
export const DEBT_DIALOG_LABEL_NEW_CYCLE_DESC = 'Resets the balance to this amount and clears the payment history';
