...
export class LoginComponent implements OnInit, AfterViewInit, OnDestroy {
	...
	protected readonly LOGIN_LABEL_EMAIL = LOGIN_LABEL_EMAIL;
	...
	protected readonly LOGIN_LABEL_NEW_PASSWORD = LOGIN_LABEL_NEW_PASSWORD;
	protected readonly LOGIN_MSG_PASSWORD_REQUIRED = LOGIN_MSG_PASSWORD_REQUIRED;
	protected readonly LOGIN_LABEL_USERNAME = LOGIN_LABEL_USERNAME;
