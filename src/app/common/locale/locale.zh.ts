...
export const NAV_LABEL_GUIDE = '使用指南';
...
export const NAV_ARIA_OPEN_GUIDE = '打开完整使用指南';
...
export const DEBT_DIALOG_LABEL_NEW_CYCLE = '新周期';
export const DEBT_DIALOG_LABEL_NEW_CYCLE_DESC = '将余额重置为此金额并清空还款记录';
