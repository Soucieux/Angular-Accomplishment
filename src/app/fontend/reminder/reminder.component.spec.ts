...
describe('ReminderComponent', () => {
    ...
    beforeEach(async () => {
        ...
        mockUtilities = jasmine.createSpyObj<Utilities>('Utilities', ['getIsUserAlive', 'checkIfHoverCapable']);
    ...
    describe('addNewTextOnly', () => {
        ...
        it('calls addNewRecordForReminderTable with the trimmed text', async () => {
    ...
    describe('onCardTextUpdate', () => {
        ...
        it('calls updateReminderTable when text has changed', async () => {
            ...
            expect(mockDb.updateReminderTable).toHaveBeenCalledWith(
                DATABASE_REMINDER, 'k1', PINBOARD_VALUE_KEY_TEXT, 'updated text'
            );
        });
    ...
    describe('clearDate', () => {
        it('sets item.date to null and writes null to DB', async () => {
            ...
            expect(mockDb.updateReminderTable).toHaveBeenCalledWith(
                DATABASE_REMINDER, 'k1', PINBOARD_VALUE_KEY_DATE, null
            );
        });
    ...
    describe('clearLink', () => {
        it('sets item.link to null and writes null to DB', async () => {
            ...
            expect(mockDb.updateReminderTable).toHaveBeenCalledWith(
                DATABASE_REMINDER, 'k1', PINBOARD_VALUE_KEY_LINK, null
            );
        });
    ...
    describe('cancelTagEdit', () => {
        it('clears the tag-edit session', () => {
            (component as any).tagEditSession = { item: makeItem('k1'), index: 0, isNewItem: false, tagText: 'x' };
    ...
    describe('onTagUpdate', () => {
        it('adds a new tag when index is -1 and text is non-empty', async () => {
            ...
            expect(mockDb.updateReminderTable).toHaveBeenCalledWith(
                DATABASE_REMINDER, 'k1', PINBOARD_VALUE_KEY_TAGS, jasmine.arrayContaining(['newtag'])
            );
        });
    ...
    describe('removeExistingCardTag', () => {
        it('removes the tag at the given index and persists to DB', async () => {
            ...
            expect(mockDb.updateReminderTable).toHaveBeenCalledWith(
                DATABASE_REMINDER, 'k1', PINBOARD_VALUE_KEY_TAGS, ['personal']
            );
        });
    ...
    describe('access-denied guard', () => {
        it('shows content when getIsUserAlive returns true', () => {
            ...
            const container = fixture.nativeElement.querySelector('.pinboard-container');
