window.VISION_GUIDE_DIRECTORY_COPY = {
	en: {
		...
		catalogueBody: 'Each guide mirrors the current application and keeps platform, permission, and responsive differences close to the action they affect.',
	...
	zh: {
		...
		catalogueBody: '每份指南都对应当前应用，并把平台、权限和响应式差异放在真正会影响操作的位置。',
		openLabel: '打开使用手记',
		pageLabel: '页面',
		completeLabel: '完整指南',
		facts: [
